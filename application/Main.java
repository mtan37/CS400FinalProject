...
public class Main extends Application implements EventHandler<ActionEvent>{
      ...
      if(quizGenerator.currChosenTopics.size() == 0 && !(numQuestion > 0)) {
        ...
        save.setOnMouseClicked(event -> {
          ...
          primaryStage.setScene(question);
            ...
            dialog.close();
            Alert alert = new Alert(AlertType.INFORMATION, "There is no further to go at this point. To explore other parts of the GUI"
	...
	private Scene setUpCurrDataBasePage() {
      ...
      //hard code for topics combo list
      //load from QuizGenerator topic TODO
      ObservableList<String> topicLs= FXCollections.observableArrayList("BST", "HashTable", "AVL-Tree", "Graph", "Linux", "Set");
