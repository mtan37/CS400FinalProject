		...
		saveButton.setOnAction(event -> {
			...
			if (topicField.getText().isEmpty()) {
				...
				save.setOnMouseClicked(events -> {
					...
					choiceBox1.getChildren().clear();
					choiceBox2.getChildren().clear();

					TextField newChoiceField1 = new TextField();
					TextField newChoiceField2 = new TextField();
					choiceBox1.getChildren().add(newChoiceField1);
