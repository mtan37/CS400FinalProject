...
public class Main extends Application implements EventHandler<ActionEvent> {
	...
	private Scene setUpAddQuestionPage() {
		...
		// representing the each choice column including the text field and true/false
		// button
		...
		saveButton.setOnAction(event -> {
			saveFunction(topicField, descriptionArea, imageField, choiceLabel, choicesBox, choicePrompt);
		});
		...
		centerVBox.getChildren().addAll(topicBox, descriptionBox, imageBox, choicesBox, buttonBox, saveButton);
	 ...
	 * @param choicePrompt
	 */
	private void saveFunction(TextField topicField, TextArea descriptionArea, TextField imageField, Label choiceLabel, VBox choicesBox, 
			Label choicePrompt) {
